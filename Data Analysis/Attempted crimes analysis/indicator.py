...
if __name__ == '__main__':
    ...
    overall = overall_a.map(lambda x: (x[3], x[5]))
    ...
    final_brooklyn.saveAsTextFile('brooklyn_indicator.csv')
    ...
    manhattan = manhattan_b.map(lambda x: (x[3], x[5]))
    ...
    final_staten.saveAsTextFile('staten_indicator.csv')
