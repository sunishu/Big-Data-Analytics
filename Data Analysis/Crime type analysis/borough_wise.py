...
if __name__ == '__main__':
    ...
    overall = overall_a.map(lambda x: (x[0].split('/')[0], x[3]))
    ...
    final_brooklyn.saveAsTextFile('brooklyn_BY_MONTH.csv')
    ...
    manhattan = manhattan_b.map(lambda x: (x[0].split('/')[0], x[3])) 
    ...
    final_staten.saveAsTextFile('staten_BY_MONTH.csv')
